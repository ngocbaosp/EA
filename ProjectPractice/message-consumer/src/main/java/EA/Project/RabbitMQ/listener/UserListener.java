...
public class UserListener {
    ...
    public void post(@Payload PostInfo postInfo, @Header("MessageType") String operation) {
        ...
        List<UserInfo> userInfoList = postMessageInfoService.getAll(postInfo.getPostedBy().getUserId());
        ...
        for(UserInfo userInfo:userInfoList)
        {
            ...
            postMessageInfoRepository.save(new PostMessageInfo(postInfo,userInfo.getUserId(),1));
        }
